<template>
	<nav class="navigation">
		<section class="logo-container">
			<g-link to="/">
				<img class="logo" :src="logo.logoUrl" :title="logo.title" :alt="logo.title" />
			</g-link>
		</section>
		...
		<section :class="{active: menuActive}" class="menu-item-container">
			<ul class="menu">
				<li class="menu-item menuItemWithSub">
					<button @click="subMenu" :class="{active:subMenuActive}" class="link button">
					...
					<transition name="slide-fade">
						<ul v-if="subMenuActive" class="sub-menu-container theme-container">
							<li v-for="theme in themes" :key="theme.node.id" @click.prevent="subMenuSmall">
								<g-link :to="theme.node.path+'#main'" class="link sub-link">
									<span>-</span>
									{{theme.node.theme}}
								</g-link>
							</li>
...
export default {
	...
	methods: {
		...
		subMenuSmall() {
			if (this.menuActive === true && this.subMenuActive === true) {
				this.menuActive = false;
				this.subMenuActive = false;
			} else {
				this.subMenuActive = false;
